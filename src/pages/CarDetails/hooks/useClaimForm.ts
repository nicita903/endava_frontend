...
import { getDefaultClaimFormValues } from "../utils";
import { hasValidationErrors, validateClaimFormValues } from "../validation";
...
export const useClaimForm = () => {
   ...
   */
  const updateField = (field: keyof ClaimFormValues, value: string) => {
